...
export const dict: Record<Locale, Dict> = {
  en: {
    ...
    powered_by: "HealthFlow Copilot · multi-agent reasoning",
    mock_mode_banner: "Demo mode — running on a deterministic mock provider. Configure the AI provider key to enable live mode.",
    live_mode_banner: "Live — HealthFlow Copilot is connected to its AI provider.",
  ...
  ar: {
    ...
    powered_by: "HealthFlow Copilot · استدلال متعدد الوكلاء",
    mock_mode_banner: "وضع تجريبي — يعمل على نموذج محاكاة. اضبط مزود الذكاء الاصطناعي لتفعيل الوضع المباشر.",
    live_mode_banner: "الوضع المباشر — HealthFlow Copilot متصل بمزود الذكاء الاصطناعي.",
